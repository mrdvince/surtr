...
mod tests {
    ...
    async fn test_list_vms_empty() {
        ...
        let _m = server.mock("GET", "/api2/json/nodes/node1/qemu")
            .with_status(200)
    ...
    async fn test_get_config() {
        let mut server = Server::new_async().await;
        let _m = server.mock("GET", "/api2/json/nodes/node1/qemu/100/config")
            .with_status(200)
            .with_header("content-type", "application/json")
            .with_body(r#"{
                "data": {
    ...
    async fn test_create_vm() {
        let mut server = Server::new_async().await;
        let _m = server.mock("POST", "/api2/json/nodes/node1/qemu")
    ...
    async fn test_update_config() {
        let mut server = Server::new_async().await;
        let _m = server.mock("POST", "/api2/json/nodes/node1/qemu/100/config")
            .match_header("content-type", "application/x-www-form-urlencoded")
            .match_body(Matcher::AllOf(vec![
    ...
    async fn test_delete_vm() {
        let mut server = Server::new_async().await;
        let _m = server.mock("DELETE", "/api2/json/nodes/node1/qemu/100?purge=1")
            .with_status(200)
            .with_header("content-type", "application/json")
            .with_body(r#"{
    ...
    async fn test_delete_vm_no_purge() {
        let mut server = Server::new_async().await;
        let _m = server.mock("DELETE", "/api2/json/nodes/node1/qemu/100")
            .with_status(200)
            .with_header("content-type", "application/json")
            .with_body(r#"{
                "data": "UPID:node1:00001234:00000000:5F000000:qmdestroy:100:root@pam:"
    ...
    async fn test_start_vm() {
        let mut server = Server::new_async().await;
        let _m = server.mock("POST", "/api2/json/nodes/node1/qemu/100/status/start")
            .with_status(200)
            .with_header("content-type", "application/json")
            .with_body(r#"{
    ...
    async fn test_stop_vm() {
        let mut server = Server::new_async().await;
        let _m = server.mock("POST", "/api2/json/nodes/node1/qemu/100/status/stop")
            .with_status(200)
            .with_header("content-type", "application/json")
            .with_body(r#"{
    ...
    async fn test_get_status() {
        let mut server = Server::new_async().await;
        let _m = server.mock("GET", "/api2/json/nodes/node1/qemu/100/status/current")
            .with_status(200)
            .with_header("content-type", "application/json")
            .with_body(r#"{
                "data": {
